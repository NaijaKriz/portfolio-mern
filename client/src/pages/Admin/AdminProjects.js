    ...
    <div>
        ...
        {projects.map((projects) => (
            <div className="shadow border p-5 border-gray-400 flex flex-col gap-5">
                ...
                <hr />
                <h1><span className="font-bold">Image:</span> <img src={projects.image} alt='' className='h-60 w-full'/> </h1>
                <h1><span className="font-bold">Role:</span> {projects.title}</h1>
                <h1><span className="font-bold">Description:</span> {projects.description}</h1> 
                <h1><span className="font-bold">Project Link:</span> {projects.link}</h1> 
